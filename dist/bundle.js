$(window).on("load", function () {
  ...
  var a = {},
    o =
      '"https://docs.google.com/spreadsheets/d/1CITHb4uzfqCj1Q7E9cvWkV4pkY27i_CTGfDLLuIwr70/edit#gid=0"',
  ...
  function l(r, l) {
    ...
    for (i in l) {
      ...
      var J = I[w[O] ? w[O].split(".").pop().toLowerCase() : ""] || "img";
      if (
        (J &&
          ((M = $("<" + J + ">", {
            src: w[O],
          ...
          (A = $("<div></div", { class: J + "-container" })
            .append(M)
            .after(z))),
        w[O] && w[O].indexOf("youtube.com/") > -1)
      ) {
        -1 != (E = (D = w[O].split("v=")[1]).indexOf("&")) &&
          (D = D.substring(0, E));
        var j = "https://www.youtube.com/embed/" + D + "/";
        (M = $("<iframe></iframe>", {
          src: j,
          width: "100%",
          height: "100%",
      ...
      var D,
        E,
        G = I[w[S] ? w[S].split(".").pop().toLowerCase() : ""] || "img";
      G &&
        ((P = $("<" + G + ">", {
          src: w[S],
          controls: "audio" === G ? "controls" : "",
          alt: w.Chapter,
        })),
        "yes" === n("_enableLightbox") &&
          "img" === G &&
        ...
        (H = $("<div></div", { class: G + "-container" })
          .append(P)
          .after(F))),
        w[S] &&
          w[S].indexOf("youtube.com/") > -1 &&
          (console.log("Will this thing display"),
          -1 != (E = (D = w[S].split("v=")[1]).indexOf("&")) &&
            (D = D.substring(0, E)),
          (j = "https://www.youtube.com/embed/" + D + "/"),
          (P = $("<iframe></iframe>", {
            src: j,
            width: "100%",
            height: "100%",
    ...
    if (
      ...
      var B = parseInt(location.hash.substr(1)) - 1;
      $("#contents").animate(
        { scrollTop: $("#container" + B).offset().top },
        2e3
      );
    }
    var R = n("_googleAnalytics");
    if (R && R.length >= 10) {
      var V = document.createElement("script");
      function Y() {
        dataLayer.push(arguments);
      }
      V.setAttribute("src", "https://www.googletagmanager.com/gtag/js?id=" + R),
